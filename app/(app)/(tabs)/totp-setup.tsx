...
const s = StyleSheet.create({
  ...
  card: { backgroundColor: '#fff', borderRadius: 28, padding: 24, shadowColor: '#000', shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.04, shadowRadius: 12, elevation: 3, marginBottom: 20, borderWidth: 1, borderColor: '#F8FAFC' },
  cardTitle: { fontSize: 16, fontWeight: '800', color: '#111827', marginBottom: 10 },
  cardDesc:  { fontSize: 14, color: '#4B5563', lineHeight: 22 },
  heroCard: { backgroundColor: '#EFF6FF', borderRadius: 28, padding: 28, alignItems: 'center', marginBottom: 20, borderWidth: 1, borderColor: '#BFDBFE' },
  heroTitle: { fontSize: 18, fontWeight: '700', color: '#1E40AF', marginBottom: 8 },
  heroDesc:  { fontSize: 14, color: '#3B82F6', lineHeight: 22, textAlign: 'center' },
  infoCard: { backgroundColor: '#fff', borderRadius: 28, padding: 24, shadowColor: '#000', shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.04, shadowRadius: 12, elevation: 3, marginBottom: 24, borderWidth: 1, borderColor: '#F8FAFC' },
  infoTitle: { fontSize: 13, fontWeight: '800', color: '#6B7280', textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 16 },
  infoItem:  { fontSize: 14, color: '#374151', marginBottom: 10, lineHeight: 20 },
  statusCard: { backgroundColor: '#F0FDF4', borderRadius: 24, padding: 24, marginBottom: 20, borderWidth: 1, borderColor: '#BBF7D0' },
  ...
  statusText: { fontSize: 15, fontWeight: '800', color: '#16A34A' },
  statusDesc: { fontSize: 14, color: '#15803D', lineHeight: 22 },
  ...
  secretBox: { marginTop: 20, backgroundColor: '#F9FAFB', borderRadius: 16, padding: 16, borderWidth: 1, borderColor: '#E5E7EB' },
  ...
  copyBtn: { backgroundColor: '#1565C0', borderRadius: 12, paddingVertical: 12, alignItems: 'center' },
  copyBtnTxt: { color: '#fff', fontSize: 14, fontWeight: '700' },
  fieldLabel: { fontSize: 14, fontWeight: '700', color: '#374151', marginBottom: 10, marginTop: 20 },
  ...
  primaryBtn: { backgroundColor: '#1565C0', borderRadius: 16, height: 56, alignItems: 'center', justifyContent: 'center', marginTop: 4 },
  primaryTxt: { color: '#fff', fontSize: 16, fontWeight: '800' },
  ghostBtn:   { borderWidth: 1.5, borderColor: '#E5E7EB', borderRadius: 16, height: 56, paddingHorizontal: 20, alignItems: 'center', justifyContent: 'center' },
  ghostTxt:   { color: '#64748B', fontSize: 15, fontWeight: '700' },
  dangerBtn:  { backgroundColor: '#FEE2E2', borderRadius: 16, padding: 18, alignItems: 'center', marginTop: 8 },
  dangerTxt:  { color: '#991B1B', fontSize: 16, fontWeight: '800' },
